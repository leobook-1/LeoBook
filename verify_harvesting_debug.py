...
async def test_odds_harvesting():
    ...
    print("Stage 2: Injecting sys.modules patches")
    with patch.dict('sys.modules', {
        ...
        print("Stage 3: Importing harvest_booking_codes")
        from Modules.FootballCom.booker.booking_code import harvest_booking_codes
        
        print("Stage 4: Starting internal patches")
    ...
    print("[SUCCESS] Odds harvesting and sync verified.")
